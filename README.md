...
Ce projet est une application de QCM interactive développée en C. Elle permet aux étudiants de passer des QCM et aux enseignants de créer de nouveaux QCM sécurisés par mot de passe.
...
Le projet utilise un `Makefile` pour automatiser la génération de l'exécutable :
